...
public:
	...
	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_20;

	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_21;

	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_22;
	
	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_23;

	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_24;
	
	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_25;	
	
	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_26;

	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_27;

	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_28;

	UPROPERTY(VisibleAnywhere, meta = (BindWidget))
	class URadialSlider* progressSlider_29;	
