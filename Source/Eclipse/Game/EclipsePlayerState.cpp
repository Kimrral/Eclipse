...
bool AEclipsePlayerState::DragFromGroundServer_Validate(APlayerCharacter* PlayerCharacterRef, const FPlayerInventoryStruct& PlayerInventoryStruct, const int32 DropArrayIndex, const bool IsAmmunition)
{
	return true;
}
